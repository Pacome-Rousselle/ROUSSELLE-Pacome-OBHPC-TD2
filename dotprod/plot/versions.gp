...
set title "Separate plots for dotprod versions per optimization flags"
...
set multiplot layout 1,2 rowsfirst title "Separate plots for dotprod versions per optimization flags" textcolor "black"
