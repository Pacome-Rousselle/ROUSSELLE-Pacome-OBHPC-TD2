...
set output "icx.png"
set title "Separate plots for icx optimization flags per dotprod version"
...
set multiplot layout 2,3 rowsfirst title "Separate plots for icx optimization flags per dotprod version" textcolor "black"
