...
set title "Separate plots for clang optimization flags per reduc version"
...
set multiplot layout 2,3 rowsfirst title "Separate plots for clang optimization flags per reduc version" textcolor "black"
